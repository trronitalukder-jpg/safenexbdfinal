        ...
        <header className="h-16 flex-shrink-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur border-b border-slate-200 dark:border-slate-800 px-3 sm:px-6 lg:px-8 flex items-center justify-between z-10 gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 min-w-0 flex-1">
            ...
            <Link
              ...
              className="flex items-center gap-2 p-1 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition min-w-0 shrink-0"
            ...
            >
              ...
              <div className="flex flex-col min-w-0 max-w-[85px] xs:max-w-[110px] sm:max-w-[150px] md:max-w-[200px]">
                ...
                {user.uniqueUserId && (
                  <span className="text-[10px] sm:text-[11px] font-semibold text-slate-500 dark:text-slate-400 truncate leading-none mt-0.5 font-mono">
            ...
            <Link
              ...
              className="relative p-2 rounded-xl border border-slate-200 dark:border-slate-700/60 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition shrink-0"
            >
